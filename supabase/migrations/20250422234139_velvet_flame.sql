/*
  # Fix team join notification message null constraint violation
  
  1. Changes
    - Fix the join_team_with_code function to ensure notification message is never null
    - Use COALESCE to provide default values for team name
    - Add explicit team name variable to avoid null concatenation
...
BEGIN
  ...
  BEGIN
    ...
    INSERT INTO notifications (
      ...
      type,
      title,
      message,  -- This will never be null now
      data,
      priority
    )
    SELECT 
