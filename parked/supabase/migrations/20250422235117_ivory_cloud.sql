/*
  # Fix team join function with double COALESCE protection
  
  1. Changes
    - Add double COALESCE protection for the notification message
    - Use a hardcoded fallback message as the final safety net
    - Ensure all parts of the message concatenation are protected
    - Add explicit NULL check for team members
