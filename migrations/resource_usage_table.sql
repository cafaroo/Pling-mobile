...
GRANT SELECT ON resource_usage TO authenticated;
GRANT ALL ON resource_usage TO service_role;
GRANT SELECT ON resource_usage_history TO authenticated;
GRANT ALL ON resource_usage_history TO service_role;
