...
import { Mail, ArrowRight, AlertCircle, Check } from 'lucide-react-native';
        ...
        >
          ...
          >
                ...
                >
                  {isLoading ? (
                    <View style={styles.loadingContainer}>
                      <Text style={styles.buttonText}>Skickar...</Text>
                    </View>
                  ) : (
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.loginButtonText}>Tillbaka till inloggning</Text>
            </TouchableOpacity>
          </Animated.View>
        </ScrollView>
      </SafeAreaView>
