/*
  # Uppdatering av målsystemet
  
  Följande ändringar görs i detta skript:
  
  1. Uppdatera goals-tabellen för att matcha nya typer och fält
  2. Byta namn på goal_milestones till milestones
  3. Lägga till taggfunktionalitet med goal_tags
  4. Lägga till relations mellan mål
  5. Skapa framstegslogg
  6. Uppdatera security policies
  
  Detta skript uppdaterar från den tidigare versionen av målsystemet
  för att matcha den nya implementationen i koden.
*/

-- Backup av existerande data (om någon)
...
-- Milestones-tabell (ersätter goal_milestones)
...
-- Skapa policies för goal_progress_logs
...
-- Funktion för att hämta användarens målstatistik
...
-- Uppdatera RLS-policies för goals
