/*
  # Fix subscription service and add safe subscription retrieval
  
  1. New Functions
    - get_team_subscription_safe: Safely get team subscription with fallback to free tier
    - ensure_team_subscription: Ensure every team has a subscription
    
  2. Changes
    - Add trigger to create subscriptions for new teams
    - Create missing subscriptions for existing teams
    
  3. Security
    - Use security definer for functions
    - Maintain proper parameter naming
*/
