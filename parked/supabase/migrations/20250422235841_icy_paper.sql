/*
  # Make team invite codes reusable
  
  1. Changes
    - Update join_team_with_code function to not mark codes as used
    - Remove the code usage check to allow multiple uses
    - Keep expiration date check to ensure codes expire properly
    - Maintain all other functionality including notifications
