/*
  # Fix subscription features function
  
  1. Changes
    - Fix ROW type handling in get_available_features function
    - Use proper record field access syntax
    - Maintain all subscription management functions
    
  2. Security
    - Keep security definer attribute
    - Maintain stable function attributes
*/
  ...
  WITH tier_features AS (
    SELECT 
      CASE tier_name
        WHEN 'free' THEN 
          ARRAY[
            ('team_members', 'count', 3)::feature_definition,
            ('monthly_sales', 'count', 50)::feature_definition,
            ('basic_analytics', 'boolean', 1)::feature_definition
          ]
        WHEN 'pro' THEN 
          ARRAY[
            ('team_members', 'count', 10)::feature_definition,
            ('monthly_sales', 'count', -1)::feature_definition,
            ('advanced_analytics', 'boolean', 1)::feature_definition,
            ('export', 'boolean', 1)::feature_definition,
            ('team_chat', 'boolean', 1)::feature_definition,
            ('custom_competitions', 'boolean', 1)::feature_definition
          ]
        WHEN 'business' THEN 
          ARRAY[
            ('team_members', 'count', 25)::feature_definition,
            ('monthly_sales', 'count', -1)::feature_definition,
            ('advanced_analytics', 'boolean', 1)::feature_definition,
            ('export', 'boolean', 1)::feature_definition,
            ('team_chat', 'boolean', 1)::feature_definition,
            ('custom_competitions', 'boolean', 1)::feature_definition,
            ('api_access', 'boolean', 1)::feature_definition,
            ('advanced_hierarchy', 'boolean', 1)::feature_definition,
            ('multiple_teams', 'boolean', 1)::feature_definition,
            ('custom_reports', 'boolean', 1)::feature_definition,
            ('sso', 'boolean', 1)::feature_definition,
            ('advanced_permissions', 'boolean', 1)::feature_definition,
            ('sales_forecasting', 'boolean', 1)::feature_definition,
            ('crm_integration', 'boolean', 1)::feature_definition
          ]
        WHEN 'enterprise' THEN 
          ARRAY[
            ('team_members', 'count', -1)::feature_definition,
            ('monthly_sales', 'count', -1)::feature_definition,
            ('advanced_analytics', 'boolean', 1)::feature_definition,
            ('export', 'boolean', 1)::feature_definition,
            ('team_chat', 'boolean', 1)::feature_definition,
            ...
            ('sales_forecasting', 'boolean', 1)::feature_definition,
            ('crm_integration', 'boolean', 1)::feature_definition,
            ('custom_development', 'boolean', 1)::feature_definition,
            ('on_premise', 'boolean', 1)::feature_definition,
            ('custom_analytics', 'boolean', 1)::feature_definition,
            ('custom_integrations', 'boolean', 1)::feature_definition,
            ('training', 'boolean', 1)::feature_definition,
            ('sla', 'boolean', 1)::feature_definition
          ]
      END AS features
  )
  SELECT 
    ...
    f.limit_type,
    f.limit_value
  FROM tier_features, unnest(features) AS f;
$$;
