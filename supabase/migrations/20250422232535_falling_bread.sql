/*
  # Fix join_team_with_code function return type
  
  1. Changes
    - Update join_team_with_code function to explicitly return json type
    - Fix the function signature to match its implementation
...
BEGIN
  ...
  BEGIN
    ...
    SELECT 
      ...
      'A new member has requested to join ' || v_code_record.name,
      json_build_object(
