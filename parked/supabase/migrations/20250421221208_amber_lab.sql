/*
  # Add competition categories and status management
  
  1. New Tables
    - `competition_categories`
      - Categories for organizing competitions
      - Color themes and icons for visual distinction
...
-- Add category and status to competitions
...
DO $$ 
BEGIN
    DROP POLICY IF EXISTS "Anyone can view competition categories" ON competition_categories;
EXCEPTION
