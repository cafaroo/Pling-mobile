...
interface AddMemberFormPresentationProps {
  // Data
  userId: string;
  role: string;
  error: string | null;
...
/**
 * Presentationskomponent för att lägga till en teammedlem
 */
export const AddMemberFormPresentation: React.FC<AddMemberFormPresentationProps> = ({
  userId,
  role,
  error,
  isLoading,
        ...
        <View style={styles.roleContainer}>
          {roles.map((roleItem) => (
            <TouchableOpacity
              ...
              disabled={isLoading}
              onPress={() => onRoleChange(roleItem.id)}
            >
              <Text 
                style={[
