/*
  # Fix team subscription function and ensure all teams have subscriptions
  
  1. New Functions
    - `get_team_subscription_safe`: Safely get team subscription with fallback to free tier
    - `ensure_team_subscription`: Trigger function to ensure new teams get a subscription
    
  2. Changes
    - Create trigger to automatically create subscriptions for new teams
    - Backfill subscriptions for existing teams that don't have one
*/
